...
export default function Careers() {
  ...
  // Assuming `listing.biodescr` contains the description text
  // const truncatedDescription = listing.biodescr.slice(0, 300);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {userListings.map((listing) => (
            <div className="bg-white shadow-md rounded-lg p-6">
              ...
              {/* <p className="text-gray-600 mb-4">{listing.biodescr}</p> */}

              {/* Check if biodescr exists before truncating */}
              {listing.biodescr && (
                <p className="text-gray-600 mb-4">
